...
player_rect = player.get_rect(center = (80, 400))
...
def create_enemy():
    ...
    enemy_size = enemy.get_size() # (30, 30)
    enemy_height = enemy.get_height()
    enemy_width = enemy.get_width()
#    enemy = pygame.Surface(enemy_size)
#    enemy.fill(COLOR_BLUE)
#    enemy_rect = pygame.Rect(WIDTH, random.randint(50, 1030), *enemy_size )
...
def create_bonus():
    ...
    bonus_size = bonus.get_size()  # (30, 30)
    bonus_height = bonus.get_height() 
    bonus_width = bonus.get_width()
#    bonus = pygame.Surface(bonus_size)  
#    bonus.fill(COLOR_GREEN)
#    bonus_rect = pygame.Rect(random.randint(50, 1870), 0, *bonus_size )
